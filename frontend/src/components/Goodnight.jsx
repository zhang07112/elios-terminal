...
export default function Goodnight({ api }) {
  ...
  return (
    <div style={{ height: '100%', overflow: 'auto', padding: 32, background: 'linear-gradient(180deg, #0b1026 0%, #1a1f3a 40%, #2a2f4a 70%, #1a2a3a 100%)', position: 'relative' }}>
      {STAR_STYLES.map((s, i) => (
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', color: '#e8e4d8' }}>
